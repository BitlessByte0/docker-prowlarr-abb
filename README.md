...
This is a fork of docker-prowlarr from the linuxserver.io team that adds AudioBookBay back into Prowlarr. The application is exactly identical to linuxserver.io's except for the User-Agent that gets sent to AudioBookBay.
